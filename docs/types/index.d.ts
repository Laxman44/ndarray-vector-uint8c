...
import { Order, Mode, uint8cndarray } from '@stdlib/types/ndarray';
...
interface Uint8ClampedVector {
	...
	* // returns 0
	*/
	new ( options?: Options ): uint8cndarray;
	...
	* var numel = require( '@stdlib/ndarray-numel' );
	*
	* var arr = new Uint8ClampedVector( 2 );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 2
	*/
	new ( length: number, options?: Options ): uint8cndarray;
	...
	* var numel = require( '@stdlib/ndarray-numel' );
	*
	* var arr = new Uint8ClampedVector( [ 1, 2 ] );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 2
	*/
	new ( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): uint8cndarray;
	...
	* var arr = new Uint8ClampedVector( buf );
	* // returns <ndarray>
	*
	* var len = numel( arr );
	* // returns 32
	*/
	new ( buffer: ArrayBuffer, options?: Options ): uint8cndarray;
	...
	* // returns 24
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, options?: Options ): uint8cndarray;
	...
	* // returns 2
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, length: number, options?: Options ): uint8cndarray;
	...
	* // returns 2
	*/
	( length: number, options?: Options ): uint8cndarray;
	...
	* // returns 2
	*/
	( obj: Collection<unknown> | AccessorArrayLike<unknown> | Iterable<unknown>, options?: Options ): uint8cndarray;
	...
	* // returns 32
	*/
	( buffer: ArrayBuffer, options?: Options ): uint8cndarray;
	...
	* // returns 24
	*/
	( buffer: ArrayBuffer, byteOffset: number, options?: Options ): uint8cndarray;
	...
	* // returns 2
	*/
	( buffer: ArrayBuffer, byteOffset: number, length: number, options?: Options ): uint8cndarray;
}
...
*
* var buf = new ArrayBuffer( 32 );
* var arr = new Uint8ClampedVector( buf, 8, 2 );
* // returns <ndarray>
*
* var len = numel( arr );
* // returns 2
*/
declare var ctor: Uint8ClampedVector;
